...
const bvec16 = @Vector(16, u8);
const bvec2 = @Vector(2, u8);

pub const edge_connections = [12]bvec2{
    .{ 0, 1 }, .{ 1, 2 }, .{ 2, 3 }, .{ 3, 0 },
    .{ 4, 5 }, .{ 5, 6 }, .{ 6, 7 }, .{ 7, 4 },
    .{ 0, 4 }, .{ 1, 5 }, .{ 2, 6 }, .{ 3, 7 },
};

pub const corner_offsets = [8]@Vector(3, f16){
    .{ 0, 0, 1 },
    .{ 1, 0, 1 },
    .{ 1, 0, 0 },
    .{ 0, 0, 0 },
...
pub const tri_table: [256]bvec16 = [_]bvec16{
